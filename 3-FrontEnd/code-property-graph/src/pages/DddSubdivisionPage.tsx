...
import { DddSubdivisionCanvas } from '../components/graph/DddSubdivisionCanvas'
import type { GraphNode } from '../types'

export function DddSubdivisionPage() {
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          <span style={{
            ...
            Entities · Common · Features · Repositories · Controllers…
          </span>
          ...
          {isLoading && (
            <div style={{
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ color: '#64748b', fontSize: 14 }}>Mapeando subdivisões…</p>
              </div>
            </div>
          )}
